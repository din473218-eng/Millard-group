  ...
  return (
    <section id="testimonials-section" className="py-24 bg-white border-t border-b border-brand-gold/15 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
        ...
        {/* Testimonials Slider */}
        <div className="relative min-h-[250px] flex flex-col justify-center items-center max-w-3xl mx-auto">
          ...
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="space-y-6"
            >
              <p className="font-serif text-lg md:text-2xl font-light italic text-brand-brown leading-relaxed">
              ...
              <div>
                ...
                <span className="font-mono text-[10px] tracking-wider text-brand-gold uppercase block mt-1 font-semibold">
